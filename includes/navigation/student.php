    ...
    <ul class="menu-items">
      <?php if (!empty($_SESSION['Enrollment_No'])) { ?>
        ...
        <li class="">
            ...
            <?php if ((trim($_SESSION['Admission_Session']) == "July-21" && $_SESSION['Duration'] == '6') || (trim($_SESSION['Admission_Session']) == "July-22" && $_SESSION['Duration'] == '4') || (trim($_SESSION['Admission_Session']) == "July-23" && $_SESSION['Duration'] == '2')) { ?>
            <li class="">
