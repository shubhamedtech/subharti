...
<div class="modal-header clearfix text-left">
  ...
  <h5>Add <span class="semi-bold"></span>Counsellor</h5>
</div>
<form role="form" id="form-add-counsellors" action="/app/counsellors/store" method="POST" enctype="multipart/form-data">
