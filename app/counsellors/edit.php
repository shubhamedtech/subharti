...
<div class="modal-header clearfix text-left">
  ...
  <h5>Edit <span class="semi-bold"></span>Counsellor</h5>
</div>
<form role="form" id="form-edit-counsellors" action="/app/counsellors/update" method="POST" enctype="multipart/form-data">
