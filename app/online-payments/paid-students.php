                    ...
                    <table class="table table-hover nowrap" id="departments-table">
                        ...
                        <tbody>
                            ...
                            if ($students->num_rows > 0) {
                               ...
                               $reg_fees = $conn->query("SELECT Fee as reg_fee FROM Student_Ledgers WHERE Student_ID = ".$student['std_ID']." AND Source ='Registration Fee' ");
                               $reg_fees = $reg_fees->fetch_assoc();
                               $reg_fees =   $reg_fees['reg_fee']; 
                            ?>
                                    <tr>
                                        ...
                                        if ($_SESSION['Role'] == "Center" || $_SESSION['Role'] == "Administrator") {
                                            ...
                                            <td><?= "&#8377; " . number_format($centerArr['Fee']+$reg_fees, 2); ?></td>
                                        <?php } else { ?>
