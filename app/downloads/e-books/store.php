    ...
    if(isset($_FILES["file"]['tmp_name']) && $_FILES["file"]['tmp_name']!=''){
      ...
      if(in_array($file_extension, $allowed_file_extensions)){
        if(!move_uploaded_file($tmp_name, $file_folder.$file)){
          ...
          $update = $conn->query("INSERT INTO Downloads (Category, Name, File, University_ID) VALUES ('E-Books', '$name', '$file', $university_id)");
          echo json_encode(['status'=>200, 'message'=>'E-Book uploaded successfully!']);
        }
      }else{
