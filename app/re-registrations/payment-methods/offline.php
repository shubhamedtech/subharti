...
?>
  ...
  <form role="form" id="form-add-offline-payments" action="/app/re-registrations/payment-methods/offline-store" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            <label>Amount</label>
            <input type="number" min="1" name="amount" id="amount" value="<?= array_sum($totalFee) ?>" readonly class="form-control" placeholder="ex: 50000" required>
          </div>
        </div>
      </div>
