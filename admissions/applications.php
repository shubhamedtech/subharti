          ...
          var applicationSettings = {
            ...
            'columns': [{
                ...
                "render": function(data, type, row) {
                  var print ='';
                  console.log(showInhouse);
                  console.log(row.Process_By_Center);
                  console.log(row.First_Name);


                  var edit = (showInhouse || row.Step < 4) &&( row.Step < 4 || row.Process_By_Center == 1) ? '<a href="/admissions/application-form?id=' + data + '"><i class="uil uil-edit mr-1" title="Edit Application Form"></i></a>' : '';
